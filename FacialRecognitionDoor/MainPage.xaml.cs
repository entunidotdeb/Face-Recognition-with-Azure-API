...
namespace FacialRecognitionDoor
{
    public sealed partial class MainPage : Page
    {
        ...
        private readonly static string s_connectionString = "HostName=iotHubDevMSDN.azure-devices.net;DeviceId=IotHubDeviceIotWorks;SharedAccessKey=41Jt2XPYRSHyQDN1qqkHA8NawctVMMWfoNMHSrKFJ0c=";
        ...
        public MainPage()
        {
            ...
            s_deviceClient.SetMethodHandlerAsync("UnlockDoor",UnlockDoor, null).ConfigureAwait(false);

        }

        private static async void SendDeviceToCloudMessagesAsync(String name)
        {
        ...
        private Task<MethodResponse> UnlockDoor(MethodRequest methodRequest, object userContext)
        {
            var data = Encoding.UTF8.GetString(methodRequest.Data);         
            //System.Diagnostics.Debug.WriteLine("Dear guest");
            door_unlcok();
            string result = "{\"result\":\"Executed direct method: " + methodRequest.Name + "\"}";
            return Task.FromResult(new MethodResponse(Encoding.UTF8.GetBytes(result), 200));

        }
          private async void door_unlcok()
        {
            await this.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                UnlockDoor("Dear Guest");
            });
        }
        ...
        private async void UnlockDoor(string visitorName)
        {
            ...
            SendDeviceToCloudMessagesAsync(visitorName);
